          ...
          <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
            <div className="w-full sm:p-4 px-4 mb-6">
              ...
              <div className="leading-relaxed text-justify text-medium">
                ...
                technical society student branch of the institution, the SB has
                played a very vital and crucial role in the development of
                ...
                science and technology. As amazing as it's past,the SB continues
                to be one of the top tier SBs of the IEEE Kerala Section,
                courtesy to it's consistently top-notch activities!!
              </div>
            </div>
